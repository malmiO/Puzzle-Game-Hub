...
class TestNQueensSolvers(unittest.TestCase):
    ...
    @patch('solver.solution_exists', return_value=False)
    @patch('solver.save_to_db')
    def test_sequential_solver(self, mock_save_to_db, mock_solution_exists):
    ...
    @patch('solver.solution_exists', return_value=False)
    @patch('solver.save_to_db')
    def test_threaded_solver(self, mock_save_to_db, mock_solution_exists):
